...
from SiteLogToGeodesyML import parser
...
def countryFullname(name):
    ...
    CountryFullnames['UNITED STATES OF AMERICA'] = "United States"
    ...
    def parse(self):
        ...
        for line in textLines:
            ...
            if re.match(type(self).Template1, line):
                ...
                HumiditySensor.End(self.siteLog.humiditySensor)
                ...
                HumiditySensor.End(self.siteLog.humiditySensor)
                PressureSensor.End(self.siteLog.pressureSensor)
                ...
                PressureSensor.End(self.siteLog.pressureSensor)
                TemperatureSensor.End(self.siteLog.temperatureSensor)
                ...
                WaterVapor.End(self.siteLog.waterVaporSensor)
